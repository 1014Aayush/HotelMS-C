...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Username->setGeometry(QRect(720, 270, 271, 41));
        Username->setStyleSheet(QString::fromUtf8("padding-left:10px;\n"
"border-radius:10px;\n"
""));
        Password = new QLineEdit(centralwidget);
        Password->setObjectName("Password");
        Password->setGeometry(QRect(720, 340, 271, 41));
...
""));
        ...
        Login->setGeometry(QRect(810, 400, 93, 41));
...
"border-radius:10px;"));
        ...
        pushButton_2->setGeometry(QRect(810, 450, 93, 29));
